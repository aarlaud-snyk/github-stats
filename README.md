...
## Github does not return results immediately. So it is very likely not to return any results at first. Try again after a few minutes and you'll get the results. This will be more gracefully handled in the next iteration. (see ![Github's word about caching](https://developer.github.com/v3/repos/statistics/))
